    ...
    <>
      <div className="lg:col-span-5 flex flex-col gap-md">
        ...
        <div className="grid grid-cols-4 gap-sm">
          <div className="aspect-square bg-surface-container-low border-2 border-primary rounded-lg overflow-hidden cursor-pointer">
            <img
              alt="Thumb 1"
          ...
          <div className="aspect-square bg-surface-container-low border border-outline-variant rounded-lg overflow-hidden cursor-pointer hover:border-primary transition-colors">
            <img
              alt="Thumb 2"
              className="w-full h-full object-cover"
      ...
      <div className="lg:col-span-4 flex flex-col gap-lg">
        <header>
          <div className="flex items-center gap-sm mb-base justify-between">
            <span className="bg-primary text-on-primary text-label-md px-2 py-0.5 rounded font-bold uppercase">
              Pre-order
            </span>
            <span className="text-on-tertiary-fixed-variant font-label-md">
              Release: Winter 2024
            </span>
          </div>
        ...
        <div className="flex flex-col gap-md">
          <p className="text-body-md text-secondary leading-relaxed">
            Experience the next generation of handheld gaming. The Nintendo
            Switch 2 features a stunning 8-inch OLED display, enhanced
            processing power for 4K TV output, and backward compatibility with
